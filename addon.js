    ...
    try {
        ...
        <svg width="${metadata.width}" height="${metadata.height}">
            ...
            <g transform="translate(0, ${metadata.height - blackBarHeight})">
                <!-- Black background that extends to bottom -->
                <rect x="0" y="0" 
                      width="${fullWidth}" height="${blackBarHeight}" 
                      fill="black" opacity="0.7"/>
                
                <!-- Centered content -->
                <g transform="translate(${contentStartX}, ${(blackBarHeight - imdbLogoSize) / 2})">
                    <!-- IMDb logo -->
                    <image x="0" y="0" 
                    ...
                    <!-- Rating text -->
                    <text x="${imdbLogoSize + spaceBetween}" y="${imdbLogoSize/2}" 
                          font-family="Arial" font-size="${ratingFontSize}" 
