    ...
    try {
        ...
        if (keywordIntent !== 'ambiguous') {
            promptText = [
                ...
                '   - NO backslashes (\\)',
                '   - NO forward slashes (/)',
                '3. Replace problematic text with alternatives:',
                '   - Use: its or it is, NOT: it\'s',
                '   - Use: does not or doesnt, NOT: doesn\'t',
                '   - Use: they say or the character says, NOT: "quoted speech"',
                '   - Use: the films message, NOT: the film\'s message',
                '',
                'RESPONSE FORMAT:',
                ...
                '                "year": 1999,',
                `                "type": \'${keywordIntent}\',`,
                '                "description": \'Plot summary here using single quotes\',',
                '                "relevance": \'Relevance explanation here using single quotes\'',
                '            }',
                '        ]',
                '    }',
                '}',
